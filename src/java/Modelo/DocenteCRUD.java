...
public List listar() {
        String sql="select * from planilla_docente";
...
public Docente listarId(int id) {
        Docente doc= new Docente();
        String sql="select * from planilla_docente where id_p_d="+id;
        Connection conn = null;
...
public int agregar(Docente doc) {
        String sql="insert into planilla_docente(nombre1, nombre2, apellido1, apellido2, cedula, sexo, fecha, nacionalidad, celular, telefono, correo, direccion, estatus)values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
     ...
     public int actualizar(Docente doc) {
        String sql="update planilla_docente set nombre1=?, nombre2=?, apellido1=?, apellido2=?, cedula=?, sexo=?, fecha=?, nacionalidad=?, celular=?, telefono=?, correo=?, direccion=?, estatus=? where id_p_d=?";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
     ...
     public void delete(int id) {
        String sql="delete from planilla_docente where id_p_d="+id;       
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
