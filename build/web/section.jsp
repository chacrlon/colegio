								...
								<table class="table table-hover text-center">
									...
									<tbody>
											...
											<td>${seccion.getEstatus()}</td>											
                                                                                ...
                                                                                <td><a href="Controlador?menu=Seccion&accion=Editar&id=${seccion.getId_s()}" class="btn btn-success btn-raised btn-xs"><i class="zmdi zmdi-refresh"></i></a></td>
									        <td><a href="Controlador?menu=Seccion&accion=Eliminar&id=${seccion.getId_s()}" class="btn btn-danger btn-raised btn-xs"><i class="zmdi zmdi-delete"></i></a></td>
